    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="View_users1.jsp">View Users</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Data Users</h2>
                ...
                <div class="container">
                    <table id="customers">
                        ...
                        <form method="post" action="user_approve.jsp">
                            <td><input style="background-color: transparent; border: none; color: black" name="duid" value="<%=rs.getString("id")%>"  type="text"  readonly=""</td>
                            <td><input style="background-color: transparent; border: none; color: black" name="duname" value="<%=rs.getString("name")%>"  type="text"  readonly=""</td>
