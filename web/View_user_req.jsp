    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="View_user_req.jsp">View User Request</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">User File Requests</h2>
                        ...
                        <th>Requested Time</th>
                            <%
                                ...
                                try {
                                    ...
                                    ResultSet rs = st1.executeQuery("Select * from request ");
                                    while (rs.next()) {
