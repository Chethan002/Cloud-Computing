    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="View_files.jsp">View Files</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Uploaded Files</h2>
                ...
                <div class="container">
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString("file_keyword")%></td>
