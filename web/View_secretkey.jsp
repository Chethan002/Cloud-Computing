    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="View_secretkey.jsp">View Secret Key Request</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">File Secret Key Requests</h2>
                ...
                <div class="container">
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="approve.jsp?uname=<%=rs.getString("uname")%>&fileid=<%=rs.getString("fileid")%>&filename=<%=rs.getString("filename")%>" style="color:seagreen ">Accept</a></td>
                        </tr>
                        <%                                        }
                            } catch (Exception ex) {
                                ex.printStackTrace();
