    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="Request_secretkey.jsp">Request Secret Key</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Request For Secret Key</h2>
                ...
                <div class="container">
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="request_key.jsp?uid=<%=rs1.getString("uid")%>&uname=<%=rs1.getString("uname")%>&doid=<%=rs.getString("doid")%>&do_name=<%=rs.getString("doname")%>&fileid=<%=rs.getString("fileid")%>&filename=<%=rs.getString("filename")%>" style="color:seagreen ">Request</a></td>
                        </tr>
                         <%                                        }
                            } else {
