    ...
    <body class="size-1140">
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Data Owner Login</h2>
                ...
                <div class="line">
                    <div class="margin">
                        ...
                        <div class="s-12 m-12 l-6">
                            <br><br><br>
                            <form class="customform" method="post" action="do_signin.jsp">
                                <div class="s-12"> 
                                ...
                                <div class="line">
                                    <div class="margin">
                                        ...
                                        <div class="s-12 m-12 l-6">
                                            <a href="do_signup.jsp" class="s-12 submit-form button background-primary text-white">Register!</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
