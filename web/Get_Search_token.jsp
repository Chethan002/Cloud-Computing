    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="Get_Search_token.jsp">Get Search Token</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Get Search Token</h2>
                ...
                <div class="container">
                    ...
                    %>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="get_token.jsp?id=<%=rs.getString("id")%>&name=<%=rs.getString("name")%>&email=<%=rs.getString("email")%>" style="color:seagreen ">Get Token</a></td>
                        </tr>
                        <%                                        }
                            } catch (Exception ex) {
                                ex.printStackTrace();
