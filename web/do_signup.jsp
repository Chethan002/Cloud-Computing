    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="DO_login.jsp">Data Owner</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Data Owner Register</h2>
                ...
                <div class="line">
                    <div class="margin">
                        ...
                        <div class="s-12 m-12 l-6">
                            <br><br><br>
                            <form class="customform" method="post" action="do_reg">
                                <div class="s-12"> 
                                    <input type="text" name="username" placeholder="Name" required="required" /><br><br>
                                </div>
                                <div class="s-12"> 
                                    <input type="date" name="dob" placeholder="DOB" required="required" /><br><br>
                                </div>
                                <div class="s-12"> 
                                ...
                                <div class="s-12"> 
                                    <input type="text" name="phone" placeholder="Phone No" required="required" /><br><br>
                                </div>
                                <div class="s-12"> 
                                ...
                                <div class="line">
                                    <div class="margin">
                                        <div class="s-12 m-12 l-6">
                                            <button class="s-12 submit-form button background-success text-white" type="submit">Sign Up</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
