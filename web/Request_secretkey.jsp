                ...
                <div class="line">
                    <div class="margin">
                        ...
                        <div class="s-12 m-12 l-6">
                            <br><br><br>
                            <form class="customform" method="post" action="request_secretkey1.jsp">
                                <div class="s-12"> 
                                    <input type="text" name="fileid" placeholder="Enter File ID" required="required" /><br><br>
                                </div>
                                <div class="s-12 m-12 l-6">
                                    <button class="s-12 submit-form button background-success text-white" type="submit">Request</button>
                                </div>
                            </form>
                        </div>
                        <div class="s-12 m-12 l-6">
