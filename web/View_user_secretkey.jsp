    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="View_user_secretkey.jsp">View Secret Key</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Get Secret Key</h2>
                ...
                <div class="container">
                    ...
                    %>
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="get_secretkey.jsp?uid=<%=rs.getString("uid")%>&uname=<%=rs.getString("uname")%>&filename=<%=rs.getString("filename")%>" style="color:seagreen ">Get Secret Key</a></td>
                        </tr>
                         <%                                        }
