    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="Cloud_login.jsp">Cloud</a></li>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">Cloud Server Login</h2>
                ...
                <div class="line">
                    <div class="margin">
                        ...
                        <div class="s-12 m-12 l-6">
                            <br><br><br>
                            <form class="customform" method="post" action="cloud">
                                <div class="s-12"> 
                                    <input type="text" name="name" placeholder="Email ID" required="required" /><br><br>
                                </div>
                                <div class="s-12">
