    ...
    <body class="size-1140">
            ...
            <nav class="background-transparent background-transparent-hightlight full-width sticky">
                ...
                <div class="top-nav s-12 l-10">
                    <ul class="right chevron">
                        ...
                        <li class="active-item"><a href="KGC_login.jsp">KGC</a></li>
                    </ul>
                </div>
            </nav>
        </header>
        ...
        <main role="main">    
            ...
            <section class="section background-white text-center">
                <div class="line">
                    <h2 class="text-size-50  text-m-size-40 text-center">KGC Login</h2>
                ...
                <div class="line">
                    <div class="margin">
                        ...
                        <div class="s-12 m-12 l-6">
                            <br><br><br>
                            <form class="customform" method="post" action="kgc">
                                <div class="s-12"> 
